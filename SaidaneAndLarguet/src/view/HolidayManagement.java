...
public class HolidayManagement extends JPanel {
	...
	private JButton cin,firstName,lastName,position,holidayType,startDate,endDate;
	...
	public void initTopPane() {
		...
		// Adding The title
		title = new JLabel("Holiday Management");
		...
		String[] searchByItems = {"ID","First Name","Last Name","Position","Holiday Type","Creation Date","Start Date","End Date"};
		
		selectSearch = new JComboBox<>(searchByItems);
		selectSearch.setMaximumRowCount(5);
	...
	public void initCenterPane() {
		...
		holidayType = new JButton("Holiday Type");
		startDate = new JButton("Start Date");
		endDate = new JButton("End Date");
		...
		tableHeaderPane.add(holidayType);
		tableHeaderPane.add(startDate);
		tableHeaderPane.add(endDate);
